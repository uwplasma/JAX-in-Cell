...
import numpy as np
from common import C_EXPLICIT, C_IMPLICIT, C_THEORY, figure, maxima, panel_label, record, savefig
...
for ax in (cc, d):
    ax.set(ylabel=r"$|W(t)-W(0)|\,/\,W(0)$", ylim=(1e-18, 1e-1))
