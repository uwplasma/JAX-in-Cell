...
![Simulation of bump-on-tail instability. (a) Snapshot of phase-space at 80 $\omega_pe^{-1}$ . (b) Time evolution of electric field energy. \label{fig:bump-on-tail}](figs/bump-on-tail.png)
