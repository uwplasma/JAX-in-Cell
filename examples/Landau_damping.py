...
input_parameters = {
    ...
    "ion_mass_over_proton_mass": 1e9, # Ion mass over proton mass
...
solver_parameters = {
    "field_solver"           : 2,    # Algorithm to solve E and B fields - 0: Curl_EB, 1: Gauss_1D_FFT, 2: Gauss_1D_Cartesian, 3: Poisson_1D_FFT, 
    "number_grid_points"     : 32,  # Number of grid points
    "number_pseudoelectrons" : 20000, # Number of pseudoelectrons
